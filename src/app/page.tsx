        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <button
                onClick={() => {
                  console.log('Attempting to navigate to: https://b3ntv1-0s.myshopify.com/a/collections/products');
                  window.open('https://b3ntv1-0s.myshopify.com/a/collections/products', '_self');
                }}
...
I replaced my morning coffee with Amali two weeks ago and I feel amazing. Not only do I have energy, but I also feel emotionally balanced and lighter — like there's an inner warmth that carries me through the day. I've never felt that from a drink."
      ...
      <section className="py-16 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <button
              onClick={() => window.open('https://b3ntv1-0s.myshopify.com/a/collections/products', '_self')}
            ...
            <p className="text-sm text-amali-gold-400 mt-2">FREE SHIPPING ON $150+</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16" style={{backgroundColor: '#B8860B20'}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-sm text-amali-gold-400 mt-2">Join thousands of satisfied customers</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img
                ...
                alt="Energy optimization article"
                className="w-full h-40 object-cover"
              />
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">
                  How Plant Energy Transforms Your Daily Performance
                </h3>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img
                src="/api/placeholder/300/200"
                alt="Organic ingredients article"
                className="w-full h-40 object-cover"
              />
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">
                  5 Exotic Ingredients That Create Clean Euphoric Energy
                </h3>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img
                src="/api/placeholder/300/200"
                alt="Energy results article"
                className="w-full h-40 object-cover"
              />
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">
                  Amali Results: Sarah Lost Fatigue & Gained 10x Energy
                </h3>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img
                src="/api/placeholder/300/200"
                alt="Ingredient guide article"
                className="w-full h-40 object-cover"
              />
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">
                  The Ultimate Guide to Organic Energy Supplements
                </h3>
              </div>
            </div>
          </div>
